...
public class ArrayListMultimap_CustomFieldSerializer {
  ...
  public static void deserialize(final SerializationStreamReader in, final ArrayListMultimap<?, ?> out) { }

  public static ArrayListMultimap<Object, Object> instantiate(final SerializationStreamReader in)
      throws SerializationException {
    return (ArrayListMultimap<Object, Object>)
        Multimap_CustomFieldSerializerBase.populate(in, ArrayListMultimap.create());
  }

  public static void serialize(final SerializationStreamWriter out, final ArrayListMultimap<?, ?> multimap)
      throws SerializationException {
