...
/**
 * Even though {@link ImmutableSortedMap} cannot be instantiated, we still need
 * a custom field serializer. TODO(cpovirk): why? Does it help if ensure that
 * the GWT and non-GWT classes have the same fields? Is that worth the trouble?
 *
 * @author Chris Povirk
 */
