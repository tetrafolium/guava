...
public class ImmutableEnumMap_CustomFieldSerializer {
  ...
  public static void deserialize(
      final SerializationStreamReader reader, final ImmutableEnumMap<?, ?> instance) { }
  ...
  public static void serialize(final SerializationStreamWriter writer, final ImmutableEnumMap<?, ?> instance)
