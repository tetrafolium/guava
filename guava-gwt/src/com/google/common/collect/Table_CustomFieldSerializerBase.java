...
/**
 * This class contains static utility methods for writing {@link Table} GWT
 * field serializers. Serializers should delegate to {@link #serialize} and
 * {@link #populate}.
 *
 * <p>For {@link ImmutableTable}, see {@link
...
final class Table_CustomFieldSerializerBase {
  ...
  static void serialize(SerializationStreamWriter writer,
     ...
     * that the row, column and values, along with any comparators, are all
     * serializable).
     */
