...
public class TypeResolverTest extends TestCase {
  ...
  public <T> void testWhere_wildcardTypeMapping() {
    ...
    assertEquals(String.class, new TypeResolver()
        .where(new TypeCapture<List<? extends T>>() {
    }.capture(),
        new TypeCapture<List<? extends String>>() {
    }.capture())
        .resolveType(t));
    assertEquals(String.class, new TypeResolver()
        .where(new TypeCapture<List<? super T>>() {
    }.capture(),
        new TypeCapture<List<? super String>>() {
    }.capture())
        .resolveType(t));
  ...
  public <K, V> void testWhere_actualArgHasWildcard() {
    ...
    assertEquals(
      Integer.class, resolver.resolveType(new TypeCapture<V>() {
    }.capture()));
  }
  ...
  public <T> void testWhere_mapFromWildcard() {
    ...
    assertEquals(new TypeCapture<TypedKeyMap<String>>() {
    }.capture(),
        new TypeResolver()
        .where(
