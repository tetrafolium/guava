...
public class TypeVisitorTest extends TestCase {
  ...
  public void testVisitClass() {
    ...
    new BaseTypeVisitor() {
      @Override void visitClass(final Class<?> t) { }
    }.visit(String.class);
  }
  ...
  public <T> void testVisitTypeVariable() {
    ...
    assertVisited(type);
    new BaseTypeVisitor() {
      @Override void visitTypeVariable(final TypeVariable<?> t) { }
    }.visit(type);
  }
  ...
  public void testVisitWildcardType() {
    ...
    assertVisited(type);
    new BaseTypeVisitor() {
      @Override void visitWildcardType(final WildcardType t) { }
    }.visit(type);
  }
  ...
  public <T> void testVisitGenericArrayType() {
    ...
    assertVisited(type);
    new BaseTypeVisitor() {
      @Override void visitGenericArrayType(final GenericArrayType t) { }
    }.visit(type);
  }
  ...
  public <T> void testVisitParameterizedType() {
    ...
    assertVisited(type);
    new BaseTypeVisitor() {
      @Override void visitParameterizedType(final ParameterizedType t) { }
    }.visit(type);
  }
  ...
  private static void assertVisited(final Type type) {
