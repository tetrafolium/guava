...
/**
 * Compare CacheBuilder and MapMaker performance, ensuring that they remain on
 * par with each other.
 *
...
public class MapMakerComparisonBenchmark {
  ...
  private final Map<Object, Object> map =
      new MapMaker().makeMap(); // Returns ConcurrentHashMap
  private final Cache<Object, Object> cache =
      CacheBuilder.newBuilder().recordStats().build();
  private final Cache<Object, Object> cacheNoStats =
