...
public class SetContainsBenchmark {
  // Start at 4.88 then multiply by 2*2^phi <evil cackle> - The goal is be
  // uniform yet visit a variety of "values-relative-to-the-next-power-of-2"
  ...
  @Param({"HashSetImpl", "ImmutableSetImpl"}) private SetImpl impl;
