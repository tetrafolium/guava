...
public final class Callables {
   ...
   *
   * <p>The {@link AsyncCallable} returns the {@link ListenableFuture} resulting
   * from
  ...
  /**
   * Wraps the given callable such that for the duration of {@link
   * Callable#call} the thread that is running will have the given name.
   *
   *
