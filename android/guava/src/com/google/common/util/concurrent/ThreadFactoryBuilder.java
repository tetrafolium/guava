 ...
 * threads <li>a {@linkplain ThreadFactoryBuilder#setNameFormat naming format}
 * <li>a {@linkplain Thread#setPriority thread priority}
 * <li>an {@linkplain Thread#setUncaughtExceptionHandler uncaught exception
 * handler} <li>a {@linkplain ThreadFactory#newThread backing thread factory}
 * </ul>
 * <p>If no backing thread factory is provided, a default backing thread factory
 * is used as if by calling {@code setThreadFactory(}{@link
...
public final class ThreadFactoryBuilder {
   ...
   *     example, {@code "rpc-pool-%d"} will generate thread names like {@code
   * "rpc-pool-0"},
  ...
  // Split out so that the anonymous ThreadFactory can't contain a reference
  // back to the builder. At least, I assume that's why. TODO(cpovirk): Check,
