...
public final class Futures extends GwtFuturesCatchingSpecialization {
  ...
  public static <V, X extends Exception> CheckedFuture<V, X> makeChecked(
      final ListenableFuture<V> future, final Function<? super Exception, X> mapper) {
   ...
   */
  public static <V> ListenableFuture<V> immediateFuture(final @Nullable V value) {
    if (value == null) {
  ...
  public static <O> ListenableFuture<O> scheduleAsync(
      final AsyncCallable<O> callable,
      final long delay,
  ...
  public static <I, O> ListenableFuture<O> transformAsync(
      final ListenableFuture<I> input, final AsyncFunction<? super I, ? extends O> function) {
   ...
   */
  public static <I, O> ListenableFuture<O> transform(
      final ListenableFuture<I> input, final Function<? super I, ? extends O> function, final Executor executor) {
    return AbstractTransformFuture.create(input, function, executor);
  }
  ...
  public static <V> ListenableFuture<V> dereference(
      final ListenableFuture<? extends ListenableFuture<? extends V>> nested) {
  ...
  public static final class FutureCombiner<V> {
    ...
    private FutureCombiner(
        final boolean allMustSucceed, final ImmutableList<ListenableFuture<? extends V>> futures) {
  ...
  private static final class InCompletionOrderState<T> {
    ...
    private void recordInputCompletion(
        final ImmutableList<AbstractFuture<T>> delegates, final int inputFutureIndex) {
  ...
  public static <V> void addCallback(
      final ListenableFuture<V> future, final FutureCallback<? super V> callback) {
  ...
  public static <V, X extends Exception> V getChecked(final Future<V> future, final Class<X> exceptionClass)
      throws X {
