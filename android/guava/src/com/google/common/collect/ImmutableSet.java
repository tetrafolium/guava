...
public abstract class ImmutableSet<E>
   ...
   * specified array. If
   * {@code k} is the size of the returned {@code ImmutableSet}, then the unique
   * elements of {@code elements} will be in the first {@code k} positions, and
   * {@code elements[i] == null} for {@code k <= i < n}.
   *
   * <p>After this method returns, {@code elements} will contain no duplicates,
   * but {@code elements} may be the real array backing the returned set, so do
   * not modify it further.
   *
  ...
  private static <E> ImmutableSet<E> construct(int n, Object... elements) {
    ...
    if (uniques == 1) {
      ...
      Object[] uniqueElements = shouldTrim(uniques, elements.length)
  ...
  public static class Builder<E>
    ...
    public ImmutableSet<E> build() {
      ...
      default:
        ...
        if (hashTable != null && chooseTableSize(size) == hashTable.length) {
          Object[] uniqueElements = shouldTrim(size, contents.length)
