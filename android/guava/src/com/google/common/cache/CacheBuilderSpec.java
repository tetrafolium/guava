 ...
 *
 * <p>{@code CacheBuilderSpec} supports parsing configuration off of a string,
 * which makes it especially useful for command-line configuration of a {@code
 * CacheBuilder}.
 *
 * <p>The string syntax is a series of comma-separated keys or key-value pairs,
 * each corresponding to a {@code CacheBuilder} method. <ul> <li>{@code
 * concurrencyLevel=[integer]}: sets {@link CacheBuilder#concurrencyLevel}.
 * <li>{@code initialCapacity=[integer]}: sets {@link
 * CacheBuilder#initialCapacity}. <li>{@code maximumSize=[long]}: sets {@link
 * CacheBuilder#maximumSize}. <li>{@code maximumWeight=[long]}: sets {@link
 * CacheBuilder#maximumWeight}. <li>{@code expireAfterAccess=[duration]}: sets
 * {@link CacheBuilder#expireAfterAccess}. <li>{@code
 * expireAfterWrite=[duration]}: sets {@link CacheBuilder#expireAfterWrite}.
 * <li>{@code refreshAfterWrite=[duration]}: sets {@link
 * CacheBuilder#refreshAfterWrite}. <li>{@code weakKeys}: sets {@link
 * CacheBuilder#weakKeys}. <li>{@code softValues}: sets {@link
 * CacheBuilder#softValues}. <li>{@code weakValues}: sets {@link
 * CacheBuilder#weakValues}. <li>{@code recordStats}: sets {@link
 * CacheBuilder#recordStats}.
 * </ul>
 *
 * <p>The set of supported keys will grow as {@code CacheBuilder} evolves, but
 * existing keys will never be removed.
 *
 * <p>Durations are represented by an integer, followed by one of "d", "h", "m",
 * or "s", representing days, hours, minutes, or seconds respectively. (There is
 ...
 * not be repeated; it is also illegal to use the following pairs of keys in a
 * single value: <ul> <li>{@code maximumSize} and {@code maximumWeight}
 * <li>{@code softValues} and {@code weakValues}
 * </ul>
 *
 * <p>{@code CacheBuilderSpec} does not support configuring {@code CacheBuilder}
 * methods with non-value parameters. These must be configured in code.
 *
 * <p>A new {@code CacheBuilder} can be instantiated from a {@code
 * CacheBuilderSpec} using
 * {@link CacheBuilder#from(CacheBuilderSpec)} or {@link
...
public final class CacheBuilderSpec {
  ...
  /**
   * Returns a string that can be used to parse an equivalent {@code
   * CacheBuilderSpec}. The order and form of this representation is not
   * guaranteed, except that reparsing its output will produce a {@code
   * CacheBuilderSpec} equal to this instance.
   */
  ...
  static class KeyStrengthParser implements ValueParser {
    ...
    public KeyStrengthParser(Strength strength) { this.strength = strength; }
  ...
  static class ValueStrengthParser implements ValueParser {
    ...
    public ValueStrengthParser(Strength strength) { this.strength = strength; }
