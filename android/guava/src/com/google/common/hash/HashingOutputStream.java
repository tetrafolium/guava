...
public final class HashingOutputStream extends FilterOutputStream {
   ...
   *
   * <p>The {@link OutputStream} should not be written to before or after the
   * hand-off.
   */
  // TODO(user): Evaluate whether it makes sense to always piggyback the
  // computation of a HashCode on an existing OutputStream, compared to creating
  // a separate OutputStream that could be (optionally) be combined with another
  // if needed (with something like MultiplexingOutputStream).
