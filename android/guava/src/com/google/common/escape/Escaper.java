 ...
 *
 * <p>Because, in general, escaping operates on the code points of a string and
 * not on its individual {@code char} values, it is not safe to assume that
 * {@code escape(s)} is equivalent to
 * {@code escape(s.substring(0, n)) + escape(s.substring(n))} for arbitrary
 ...
 * {@linkplain Character#isHighSurrogate surrogate} {@linkplain
 * Character#isLowSurrogate pairs}, or by starting with short strings already
 * known to be free of unpaired surrogates.
 *
 * <p>The two primary implementations of this interface are {@link CharEscaper}
 * and
 ...
 * com.google.common.xml.XmlEscapers}. To create your own escapers, use {@link
 * CharEscaperBuilder}, or extend {@code CharEscaper} or
 * {@code UnicodeEscaper}.
 *
...
public abstract class Escaper {
   ...
   * verify the input for well formed characters. A {@code CharEscaper} should
