 ...
 * {@code &amp;} and {@code &quot;} while
 * {@link #escapeUnsafe} is overridden to handle general escaping of the form
 * {@code &#NNNNN;}.
 *
...
public abstract class ArrayBasedUnicodeEscaper extends UnicodeEscaper {
  ...
  protected ArrayBasedUnicodeEscaper(ArrayBasedEscaperMap escaperMap,
    ...
    if (safeMin >= Character.MIN_HIGH_SURROGATE) {
      ...
      this.safeMaxChar =
          (char)Math.min(safeMax, Character.MIN_HIGH_SURROGATE - 1);
    }
  }
   ...
   * and lies outside the safe range then
