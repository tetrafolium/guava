 ...
 * very important difference. A CharEscaper can only process Java <a
 ...
 * {@link com.google.common.html.HtmlEscapers} and {@link
 * com.google.common.xml.XmlEscapers}. To create your own escapers extend this
 * class and implement the {@link #escape(int)} method.
 *
...
public abstract class UnicodeEscaper extends Escaper {
   ...
   * {@link #escape(int)} for each of them. If the semantics of your escaper are
   * such that code points in the supplementary range are either all escaped or
   * all unescaped, this method can be implemented more efficiently using {@link
   ...
   * unmatched high surrogate character, then this method will throw {@link
   ...
   * #nextEscapeIndex(CharSequence, int, int)} directly. Doing this for {@link
   * com.google.common.net.PercentEscaper} more than doubled the performance for
   * unescaped strings (as measured by {@link CharEscapersBenchmark}).
   *
   ...
   *
   * <p>Unlike {@link Character#codePointAt(CharSequence, int)} or {@link
   ...
   * returned.</b> <li>If the first character was a high surrogate value, then
   * an attempt is made to read the next character. <ol> <li><b>If the end of
   * the sequence was reached, the negated value of the trailing high surrogate
   * is returned.</b> <li><b>If the next character was a valid low surrogate,
   * the code point value of the high/low surrogate pair is returned.</b> <li>If
   * the next character was not a low surrogate value, then {@link
   *         IllegalArgumentException} is thrown.
   *     </ol>
   * <li>If the first character was a low surrogate value, {@link
   * IllegalArgumentException} is thrown.
   * </ol>
   *
