 ...
 *
 * <p>Assuming you're free to choose, note that <b>{@link #UTF_8} is widely
 * preferred</b>.
 *
 * <p>See the Guava User Guide article on <a
 * href="https://github.com/google/guava/wiki/StringsExplained#charsets">{@code
 * Charsets}</a>.
 *
 * @author Mike Bostock
 * @since 1.0
...
public final class Charsets {
   ...
   * set (ISO646-US).
   *
   * <p><b>Note for Java 7 and later:</b> this constant should be treated as
