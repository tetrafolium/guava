 ...
 * <a
 * href="http://docs.oracle.com/javase/7/docs/technotes/guides/language/assert.html">
 ...
 *
 * <p><b>Note:</b> In some cases the differences explained below can be subtle.
 ...
 * discouraged, since
 *     {@link #verifyNotNull(Object)} and {@link
 * Preconditions#checkNotNull(Object)} perform the same function with more
 * clarity.
 * </ul>
 *
 * <h3>Warning about performance</h3>
 *
 * <p>Remember that parameter values for message construction must all be
 * computed eagerly, and autoboxing and varargs array creation may happen as
 * well, even when the verification succeeds and the message ends up unneeded.
 ...
 *
 * <p>As with {@link Preconditions} error message template strings, only the
 * {@code "%s"} specifier is supported, not the full range of {@link
 * java.util.Formatter} specifiers. However, note that if the number of
...
public final class Verify {
   ...
   *     {@code errorMessageArgs[0]}, etc. Unmatched arguments will be appended
   * to the formatted message in square braces. Unmatched placeholders will be
   * left as-is.
