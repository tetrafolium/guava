 ...
 * operations {@link #putInstance} and
 ...
 * {@link TypeToken}. Instead, caller should use the type safe {@link
 * #putInstance}.
 *
 * <p>Also, if caller suppresses unchecked warnings and passes in an {@code
 * Iterable<String>} for type {@code Iterable<Integer>}, the map won't be able
 * to detect and throw type error.
 *
...
public interface TypeToInstanceMap<B> extends Map<TypeToken<? extends B>, B> {
   ...
   * bound to this specific type, not a value that may have been bound to a
   * subtype.
   */
  @Nullable<T extends B> T getInstance(TypeToken<T> type);

  /**
   * Maps the specified type to the specified value. Does <i>not</i> associate
   * this value with any of the type's supertypes.
   *
   * @return the value previously associated with this type (possibly {@code
