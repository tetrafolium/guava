...
public final class Flushables {
   ...
   * may be thrown.
   *
   * <p>If {@code swallowIOException} is true, then we don't rethrow {@code
   ...
   * @throws IOException if {@code swallowIOException} is false and {@link
   *     Flushable#flush} throws an {@code IOException}.
  ...
  /**
   * Equivalent to calling {@code flush(flushable, true)}, but with no {@code
