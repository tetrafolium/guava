...
public final class Resources {
  ...
  private static final class UrlByteSource extends ByteSource {
    ...
    private UrlByteSource(URL url) { this.url = checkNotNull(url); }
   ...
   * found using the
   * {@linkplain Thread#getContextClassLoader() context class loader}. In simple
   * environments, the context class loader will find resources from the class
   * path. In environments where different threads can have different class
   * loaders, for example app servers, the context class loader will typically
   * have been set to an appropriate loader for the current thread.
   *
