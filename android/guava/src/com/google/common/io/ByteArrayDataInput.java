 ...
 * prematurely, it throws
 * {@link IllegalStateException} to signify <i>programmer error</i>. This
 * behavior is a technical violation of the supertype's contract, which
