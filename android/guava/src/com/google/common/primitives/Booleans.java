...
public final class Booleans {
  ...
  /**
   * Returns a {@code Comparator<Boolean>} that sorts {@code true} before {@code
   * false}.
   *
   * <p>This is particularly useful in Java 8+ in combination with {@code
   * Comparators.comparing}, e.g. {@code Comparators.comparing(Foo::hasBar,
   * trueFirst())}.
   *
   * @since 21.0
   */
  ...
  /**
   * Returns a {@code Comparator<Boolean>} that sorts {@code false} before
   * {@code true}.
   *
   * <p>This is particularly useful in Java 8+ in combination with {@code
   * Comparators.comparing}, e.g. {@code Comparators.comparing(Foo::hasBar,
   ...
   * with {@code !bitSet.isEmpty()} and
   * {@code Booleans.contains(array, false)} with {@code bitSet.nextClearBit(0)
   * == sizeOfBitSet}.
   *
   ...
   * Arrays.copyOfRange(array, i, i + target.length)} contains exactly the same
   * elements as
   * {@code target}.
   *
...
outer:
   ...
   * For example,
   * {@code concat(new boolean[] {a, b}, new boolean[] {}, new boolean[] {c}}
   * returns the array
   * {@code {a, b, c}}.
   *
  ...
  private static class BooleanArrayAsList
    ...
    BooleanArrayAsList(boolean[] array) { this(array, 0, array.length); }
    ...
    boolean[] toBooleanArray() { return Arrays.copyOfRange(array, start, end); }
   ...
   * Collections.reverse(Booleans.asList(array).subList(fromIndex, toIndex))},
