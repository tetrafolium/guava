...
public final class Shorts {
   ...
   *     {@code short} type,
   *     {@link Short#MAX_VALUE} if it is too large, or {@link Short#MIN_VALUE}
   * if it is too small
   */
   ...
   * For example,
   * {@code concat(new short[] {a, b}, new short[] {}, new short[] {c}} returns
   * the array
   * {@code {a, b, c}}.
   *
   ...
   * array; equivalent to
   * {@code ByteBuffer.allocate(2).putShort(value).array()}. For example, the
   * input value {@code (short) 0x1234} would yield the byte array {@code {0x12,
   * 0x34}}.
   *
   ...
   * shorts using
   * {@link Short#decode} and {@link Short#toString()}. The returned converter
   * throws
   * {@link NumberFormatException} if the input string is invalid.
   *
   * <p><b>Warning:</b> please see {@link Short#decode} to understand exactly
  ...
  private static class ShortArrayAsList
    ...
    ShortArrayAsList(short[] array) { this(array, 0, array.length); }
    ...
    short[] toShortArray() { return Arrays.copyOfRange(array, start, end); }
