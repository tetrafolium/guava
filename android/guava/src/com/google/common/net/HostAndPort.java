...
public final class HostAndPort implements Serializable {
   ...
   * @throws IllegalStateException if no port is defined. You can use {@link
   ...
   *
   * <p>Note: Non-bracketed IPv6 literals are allowed. Use {@link
   ...
   *     fails.
   */
  private static String[] getHostAndPortFromBracketedHost(
    ...
    if (closeBracketIndex + 1 == hostPortString.length()) {
      ...
      return new String[] {host,
                           hostPortString.substring(closeBracketIndex + 2)};
    }
  }
   ...
   * like "[2001:db8::1]". Chain this call after {@link #fromString(String)} to
   * increase the strictness of the parser, and disallow IPv6 literals that
   * don't contain these brackets.
   *
   * <p>Note that this parser identifies IPv6 literals solely based on the
   * presence of a colon. To perform actual validation of IP addresses, see the
