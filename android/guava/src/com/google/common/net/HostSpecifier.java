 ...
 * given string represents a domain name, use
...
public final class HostSpecifier {
   ...
   * <li>An IPv6 address string with or without brackets, like {@code
   * [2001:db8::1]} or
   *     {@code 2001:db8::1}
   * </ul>
   *
  ...
  /**
   * Determines whether {@code specifier} represents a valid {@link
   * HostSpecifier} as described in the documentation for {@link
   * #fromValid(String)}.
   */
   ...
   * inclusion in a URI. If the host specifier is a domain name, the string will
   * be normalized to all lower case. If the specifier was an IPv6 address
   * without brackets, brackets are added so that the result will be usable in
