 ...
 * supports the concept of media ranges <a
 * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.1">defined
 * by HTTP/1.1</a>. As such, the {@code *} character is treated as a wildcard
 * and is used to represent any acceptable type or subtype value. A media type
 * may not have wildcard type with a declared subtype. The
 * {@code *} character has no special meaning as part of a parameter. All values
 * for type, subtype, parameter attributes or parameter values must be valid
 * according to RFCs <a href="http://www.ietf.org/rfc/rfc2045.txt">2045</a> and
 * <a href="http://www.ietf.org/rfc/rfc2046.txt">2046</a>.
 *
 * <p>All portions of the media type that are case-insensitive (type, subtype,
 * parameter attributes) are normalized to lowercase. The value of the {@code
 * charset} parameter is normalized to lowercase, but all others are left as-is.
 *
 * <p>Note that this specifically does <strong>not</strong> represent the value
 * of the MIME
 * {@code Content-Type} header and as such has no support for header-specific
 * considerations such as line folding and comments.
 *
 * <p>For media types that take a charset the predefined constants default to
 * UTF-8 and have a
 * "_UTF_8" suffix. To get a version without a character set, use {@link
 * #withoutParameters}.
 *
 * @since 12.0
 *
...
public final class MediaType {
  ...
  private static MediaType createConstantUtf8(String type, String subtype) {
    MediaType mediaType =
        addKnownType(new MediaType(type, subtype, UTF_8_CONSTANT_PARAMETERS));
  ...
  /*
   * The following constants are grouped by their type and ordered
   * alphabetically by the constant name within that type. The constant name
   * should be a sensible identifier that is closest to the "common name" of the
   * media. This is often, but not necessarily the same as the subtype.
   *
   * Be sure to declare all constants with the type and subtype in all
   * lowercase. For types that take a charset (e.g. all text/* types), default
   * to UTF-8 and suffix the constant name with
   * "_UTF_8".
   */

  public static final MediaType ANY_TYPE = createConstant(WILDCARD, WILDCARD);
  public static final MediaType ANY_TEXT_TYPE =
      createConstant(TEXT_TYPE, WILDCARD);
  public static final MediaType ANY_IMAGE_TYPE =
      createConstant(IMAGE_TYPE, WILDCARD);
  public static final MediaType ANY_AUDIO_TYPE =
      createConstant(AUDIO_TYPE, WILDCARD);
  public static final MediaType ANY_VIDEO_TYPE =
      createConstant(VIDEO_TYPE, WILDCARD);
  public static final MediaType ANY_APPLICATION_TYPE =
      createConstant(APPLICATION_TYPE, WILDCARD);

  /* text types */
  public static final MediaType CACHE_MANIFEST_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "cache-manifest");
  public static final MediaType CSS_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "css");
  public static final MediaType CSV_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "csv");
  public static final MediaType HTML_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "html");
  public static final MediaType I_CALENDAR_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "calendar");
  public static final MediaType PLAIN_TEXT_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "plain");
  /**
   * <a href="http://www.rfc-editor.org/rfc/rfc4329.txt">RFC 4329</a> declares
   * {@link #JAVASCRIPT_UTF_8 application/javascript} to be the correct media
   * type for JavaScript, but this may be necessary in certain situations for
   * compatibility.
   */
  public static final MediaType TEXT_JAVASCRIPT_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "javascript");
  /**
   * <a
   * href="http://www.iana.org/assignments/media-types/text/tab-separated-values">Tab
   * separated values</a>.
   *
   * @since 15.0
   */
  public static final MediaType TSV_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "tab-separated-values");
  public static final MediaType VCARD_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "vcard");
  public static final MediaType WML_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "vnd.wap.wml");
  /**
   * As described in <a href="http://www.ietf.org/rfc/rfc3023.txt">RFC 3023</a>,
   * this constant
   * ({@code text/xml}) is used for XML documents that are "readable by casual
   * users."
   * {@link #APPLICATION_XML_UTF_8} is provided for documents that are intended
   * for applications.
   */
  public static final MediaType XML_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "xml");
  /**
   * As described in <a href="https://w3c.github.io/webvtt/#iana-text-vtt">the
   * VTT spec</a>, this is used for Web Video Text Tracks (WebVTT) files, used
   * with the HTML5 track element.
   *
   * @since 20.0
   */
  public static final MediaType VTT_UTF_8 =
      createConstantUtf8(TEXT_TYPE, "vtt");

  /* image types */
  public static final MediaType BMP = createConstant(IMAGE_TYPE, "bmp");
  /**
   * The media type for the <a
   * href="http://en.wikipedia.org/wiki/Camera_Image_File_Format">Canon Image
   * File Format</a> ({@code crw} files), a widely-used "raw image" format for
   * cameras. It is found in {@code /etc/mime.types}, e.g. in <a href=
  ...
  public static final MediaType ICO =
      createConstant(IMAGE_TYPE, "vnd.microsoft.icon");
   ...
   * by <a
   * href="http://www.iana.org/assignments/media-types/image/vnd.adobe.photoshop">IANA</a>,
   * and found in {@code /etc/mime.types}, e.g. <a
   * href="http://svn.apache.org/repos/asf/httpd/httpd/branches/1.3.x/conf/mime.types"></a>
   ...
   * <a
   * href="http://en.wikipedia.org/wiki/Adobe_Photoshop#File_format">Wikipedia</a>;
   * this is the regular output/input of Photoshop (which can also export to
   * various image formats; note that files with extension "PSB" are in a
   * distinct but related format).
   *
  ...
  public static final MediaType PSD =
      createConstant(IMAGE_TYPE, "vnd.adobe.photoshop");
  public static final MediaType SVG_UTF_8 =
      createConstantUtf8(IMAGE_TYPE, "svg+xml");
  ...
  /**
   * Media type for L24 audio, as defined by <a
   * href="https://tools.ietf.org/html/rfc3190">RFC 3190</a>.
   *
   * @since 20.0
   */
  ...
  public static final MediaType BASIC_AUDIO =
      createConstant(AUDIO_TYPE, "basic");

  /**
   * Media type for Advanced Audio Coding. For more information, see
   * <a href="https://en.wikipedia.org/wiki/Advanced_Audio_Coding">Advanced
   * Audio Coding</a>.
   *
   * @since 20.0
   */
  ...
  /**
   * Media type for Vorbis Audio, as defined by <a
   * href="http://tools.ietf.org/html/rfc5215">RFC 5215</a>.
   *
   * @since 20.0
   */
  public static final MediaType VORBIS_AUDIO =
      createConstant(AUDIO_TYPE, "vorbis");
  ...
  public static final MediaType WMA_AUDIO =
      createConstant(AUDIO_TYPE, "x-ms-wma");
  ...
  public static final MediaType WAX_AUDIO =
      createConstant(AUDIO_TYPE, "x-ms-wax");

  /**
   * Media type for Real Audio. For more information, see
   * <a href="http://service.real.com/help/faq/rp8/configrp8win.html">this
   * link</a>.
   *
   * @since 20.0
   */
  public static final MediaType VND_REAL_AUDIO =
      createConstant(AUDIO_TYPE, "vnd.rn-realaudio");

  /**
   * Media type for WAVE format, as defined by <a
   * href="https://tools.ietf.org/html/rfc2361">RFC 2361</a>.
   *
   * @since 20.0
   */
  public static final MediaType VND_WAVE_AUDIO =
      createConstant(AUDIO_TYPE, "vnd.wave");
  ...
  public static final MediaType QUICKTIME =
      createConstant(VIDEO_TYPE, "quicktime");
   ...
   * see <a
   * href="ftp://www.3gpp.org/tsg_sa/TSG_SA/TSGS_23/Docs/PDF/SP-040065.pdf#page=10">3GPP
   * TS 26.244</a>.
   *
   * @since 20.0
   */
  public static final MediaType THREE_GPP_VIDEO =
      createConstant(VIDEO_TYPE, "3gpp");
  ...
  public static final MediaType THREE_GPP2_VIDEO =
      createConstant(VIDEO_TYPE, "3gpp2");

  /* application types */
  /**
   * As described in <a href="http://www.ietf.org/rfc/rfc3023.txt">RFC 3023</a>,
   * this constant
   * ({@code application/xml}) is used for XML documents that are "unreadable by
   * casual users."
   * {@link #XML_UTF_8} is provided for documents that may be read by users.
   */
  public static final MediaType APPLICATION_XML_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "xml");
  public static final MediaType ATOM_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "atom+xml");
  public static final MediaType BZIP2 =
      createConstant(APPLICATION_TYPE, "x-bzip2");

  /**
   * Media type for <a
   * href="https://www.dartlang.org/articles/embedding-in-html/">dart files</a>.
   *
   * @since 19.0
   */
  public static final MediaType DART_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "dart");
  ...
  /**
   * Media type for <a
   * href="http://en.wikipedia.org/wiki/Embedded_OpenType">Embedded OpenType</a>
   * fonts. This is
   * <a
  ...
  public static final MediaType EOT =
      createConstant(APPLICATION_TYPE, "vnd.ms-fontobject");
  /**
   * As described in the <a href="http://idpf.org/epub">International Digital
   * Publishing Forum</a> EPUB is the distribution and interchange format
   * standard for digital publications and documents. This media type is defined
   * in the <a href="http://www.idpf.org/epub/30/spec/epub30-ocf.html">EPUB Open
   * Container Format</a> specification.
   *
   * @since 15.0
   */
  public static final MediaType EPUB =
      createConstant(APPLICATION_TYPE, "epub+zip");
  ...
  public static final MediaType KEY_ARCHIVE =
      createConstant(APPLICATION_TYPE, "pkcs12");
  /**
   * This is a non-standard media type, but is commonly used in serving hosted
   * binary files as it is <a
   * href="http://code.google.com/p/browsersec/wiki/Part2#Survey_of_content_sniffing_behaviors">
   ...
   * does not appear in the <a
   * href="http://www.iana.org/assignments/media-types">/IANA MIME Media
   * Types</a> list. Consider
   * {@link #OCTET_STREAM} for binary data that is not being served to a
   * browser.
   *
   * @since 14.0
   */
  public static final MediaType APPLICATION_BINARY =
      createConstant(APPLICATION_TYPE, "binary");

  public static final MediaType GZIP =
      createConstant(APPLICATION_TYPE, "x-gzip");
  /**
   * <a href="http://www.rfc-editor.org/rfc/rfc4329.txt">RFC 4329</a> declares
   * this to be the correct media type for JavaScript, but {@link
   * #TEXT_JAVASCRIPT_UTF_8 text/javascript} may be necessary in certain
  ...
  public static final MediaType JSON_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "json");
  /**
   * Media type for the <a href="http://www.w3.org/TR/appmanifest/">Manifest for
   * a web application</a>.
   *
   * @since 19.0
   */
  ...
  public static final MediaType KML =
      createConstant(APPLICATION_TYPE, "vnd.google-earth.kml+xml");
  public static final MediaType KMZ =
      createConstant(APPLICATION_TYPE, "vnd.google-earth.kmz");
  ...
  public static final MediaType OCTET_STREAM =
      createConstant(APPLICATION_TYPE, "octet-stream");
  ...
  public static final MediaType POSTSCRIPT =
      createConstant(APPLICATION_TYPE, "postscript");
  /**
   * <a
   * href="http://tools.ietf.org/html/draft-rfernando-protocol-buffers-00">Protocol
   * buffers</a>
   *
   * @since 15.0
   */
  public static final MediaType PROTOBUF =
      createConstant(APPLICATION_TYPE, "protobuf");

  public static final MediaType RDF_XML_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "rdf+xml");
  public static final MediaType RTF_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "rtf");
  /**
   * Media type for SFNT fonts (which includes
   * <a href="http://en.wikipedia.org/wiki/TrueType/">TrueType</a> and
   * <a href="http://en.wikipedia.org/wiki/OpenType/">OpenType</a> fonts). This
   * is <a
   * href="http://www.iana.org/assignments/media-types/application/font-sfnt">registered</a>
   * with the IANA.
   *
   * @since 17.0
   */
  public static final MediaType SFNT =
      createConstant(APPLICATION_TYPE, "font-sfnt");
  public static final MediaType SHOCKWAVE_FLASH =
      createConstant(APPLICATION_TYPE, "x-shockwave-flash");
  public static final MediaType SKETCHUP =
      createConstant(APPLICATION_TYPE, "vnd.sketchup.skp");
  /**
   * As described in <a href="http://www.ietf.org/rfc/rfc3902.txt">RFC 3902</a>,
   * this constant
   * ({@code application/soap+xml}) is used to identify SOAP 1.2 message
   * envelopes that have been serialized with XML 1.0.
   *
   * <p>For SOAP 1.1 messages, see {@code XML_UTF_8} per <a
   * href="http://www.w3.org/TR/2000/NOTE-SOAP-20000508/">W3C Note on Simple
   * Object Access Protocol (SOAP) 1.1</a>
   *
   * @since 20.0
   */
  public static final MediaType SOAP_XML_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "soap+xml");
  public static final MediaType TAR = createConstant(APPLICATION_TYPE, "x-tar");
  /**
   * Media type for the <a
   * href="http://en.wikipedia.org/wiki/Web_Open_Font_Format">Web Open Font
   * Format</a> (WOFF) <a href="http://www.w3.org/TR/WOFF/">defined</a> by the
   * W3C. This is <a
   * href="http://www.iana.org/assignments/media-types/application/font-woff">registered</a>
   * with the IANA.
   *
   * @since 17.0
   */
  public static final MediaType WOFF =
      createConstant(APPLICATION_TYPE, "font-woff");
  /**
   * Media type for the <a
   * href="http://en.wikipedia.org/wiki/Web_Open_Font_Format">Web Open Font
   * Format</a> (WOFF) version 2 <a
   * href="https://www.w3.org/TR/WOFF2/">defined</a> by the W3C.
   *
   * @since 20.0
   */
  public static final MediaType WOFF2 =
      createConstant(APPLICATION_TYPE, "font-woff2");
  public static final MediaType XHTML_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "xhtml+xml");
  /**
   * Media type for Extensible Resource Descriptors. This is not yet registered
   * with the IANA, but it is specified by OASIS in the <a
   * href="http://docs.oasis-open.org/xri/xrd/v1.0/cd02/xrd-1.0-cd02.html">XRD
  ...
  public static final MediaType XRD_UTF_8 =
      createConstantUtf8(APPLICATION_TYPE, "xrd+xml");
  ...
  /**
   * Returns the top-level media type. For example, {@code "text"} in {@code
   * "text/plain"}.
   */
  public String type() { return type; }

  /**
   * Returns the media subtype. For example, {@code "plain"} in {@code
   * "text/plain"}.
   */
   ...
   * specified.
   *
   * @throws IllegalStateException if multiple charset values have been set for
   *     this media type
   ...
   *     support is available in this instance of the Java virtual machine
   */
   ...
   * attributes are necessary use
   * {@link #withParameters}. Prefer {@link #withCharset} for setting the {@code
   * charset} parameter when using a {@link Charset} object.
   *
   * @throws IllegalArgumentException if either {@code attribute} or {@code
   *     value} is invalid
   */
   ...
   * with the
   * {@code charset} parameter set to the {@link Charset#name name} of the given
   * charset. Only one
   * {@code charset} parameter will be present on the new instance regardless of
   * the number set on this one.
   *
   * <p>If a charset must be specified that is not supported on this JVM (and
   * thus is not representable as a {@link Charset} instance, use {@link
   * #withParameter}.
   */
   ...
   * instance. <li>The subtype of the argument is the wildcard or equal to the
   * subtype of this instance. <li>All of the parameters present in the argument
   ...
   *   PLAIN_TEXT_UTF_8.withoutParameters().is(ANY_TEXT_TYPE.withCharset(UTF_8))
   * // false PLAIN_TEXT_UTF_8.is(ANY_TEXT_TYPE.withCharset(UTF_16)) //
   * false}</pre>
   *
   * <p>Note that while it is possible to have the same parameter declared
   * multiple times within a media type this method does not consider the number
   * of occurrences of a parameter. For example,
   ...
   *     wildcard is used for the type, but not the subtype.
   */
  public static MediaType create(String type, String subtype) {
    MediaType mediaType =
        create(type, subtype, ImmutableListMultimap.<String, String>of());
    mediaType.parsedCharset = Optional.absent();
    return mediaType;
  }
  ...
  private static final class Tokenizer {
    ...
    boolean hasMore() { return (position >= 0) && (position < input.length()); }
  }
  ...
  private static final MapJoiner PARAMETER_JOINER =
  ...
  private String computeToString() {
    StringBuilder builder =
        new StringBuilder().append(type).append('/').append(subtype);
