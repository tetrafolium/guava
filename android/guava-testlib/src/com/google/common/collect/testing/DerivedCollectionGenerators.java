...
/**
 * Derived suite generators, split out of the suite builders so that they are
 * available to GWT.
 *
...
public final class DerivedCollectionGenerators {
  public static class MapEntrySetGenerator<K, V>
    ...
    @Override
    public OneSizeTestContainerGenerator<Map<K, V>, Map.Entry<K, V>>
    getInnerGenerator() {
      return mapGenerator;
    }
  }
  ...
  public static class SortedSetSubsetTestSetGenerator<E>
    ...
    public final Bound getTo() { return to; }

    public final Bound getFrom() { return from; }
    ...
    public SortedSet<E> create(Object... elements) {
      ...
      // set generators must pass SampleElements values
  ...
  /*
   * TODO(cpovirk): surely we can find a less ugly solution than a class that
   * accepts 3 parameters, exposes as many getters, does work in the
