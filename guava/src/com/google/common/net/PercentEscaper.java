 ...
 * href="https://url.spec.whatwg.org/#percent-encode">uppercase</a> hexadecimal
 * sequences.
 *
...
public final class PercentEscaper extends UnicodeEscaper {
   ...
   * %} as a safe character. This has the effect of creating an escaper which
   * has no well defined inverse but it can be useful when escaping additional
   * characters.
   *
  ...
  public PercentEscaper(String safeChars, boolean plusForSpace) {
    // TODO(user): Switch to static factory methods for creation now that class
    // is final.
