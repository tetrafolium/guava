 ...
 *
 * <p>Note that {@link #get}, {@link #getUnchecked}, and {@link #apply} all
 * expose the same underlying functionality, so should probably be overridden as
 * a group.
 *
 * @author Charles Fry
 * @since 11.0
...
public abstract class ForwardingLoadingCache<K, V>
  ...
  @Override protected abstract LoadingCache<K, V> delegate();
