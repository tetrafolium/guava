...
public enum RemovalCause {
   ...
   * invoking
   * {@link Cache#invalidate}, {@link Cache#invalidateAll(Iterable)}, {@link
   * Cache#invalidateAll()},
   * {@link Map#remove}, {@link ConcurrentMap#remove}, or {@link
   * Iterator#remove}.
   */
  EXPLICIT {
    @Override
   ...
   * the user. This can result from the user invoking {@link Cache#put}, {@link
   * LoadingCache#refresh}, {@link Map#put},
   ...
   * {@link CacheBuilder#expireAfterWrite} or {@link
