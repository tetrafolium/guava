 ...
 * backing future as desired per the <a
...
public abstract class ForwardingFuture<V>
  ...
  @Override protected abstract Future<? extends V> delegate();
  ...
  // constructor
  /**
   * A simplified version of {@link ForwardingFuture} where subclasses can pass
   * in an already constructed {@link Future} as the delegate.
   *
   * @since 9.0
   */
