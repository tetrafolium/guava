 ...
 * {@link ScheduledExecutorService}, call {@link
...
public interface ListeningScheduledExecutorService
  ...
  @Override
  ListenableScheduledFuture<?> schedule(Runnable command, long delay,
                                        TimeUnit unit);

  /** @since 15.0 (previously returned ScheduledFuture) */
  @Override
  <V> ListenableScheduledFuture<V> schedule(Callable<V> callable, long delay,
                                            TimeUnit unit);
