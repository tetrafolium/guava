 ...
 * @param <X> The type of the Exception thrown by the Future's {@code
 *     checkedGet} method
 * @author Anthony Zana
 * @since 9.0
...
public abstract class ForwardingCheckedFuture<V, X extends Exception>
  ...
  @Override protected abstract CheckedFuture<V, X> delegate();
   ...
   * This class is scheduled for removal from Guava in February 2018.
   */
  @Beta
  @Deprecated
