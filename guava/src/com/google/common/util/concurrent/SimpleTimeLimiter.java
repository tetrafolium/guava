...
/**
 * A TimeLimiter that runs method calls in the background using an {@link
 * ExecutorService}. If the time limit expires for a given method call, the
 * thread running the call will be interrupted.
 *
...
public final class SimpleTimeLimiter implements TimeLimiter {
  ...
  /**
   * Creates a TimeLimiter instance using the given executor service to execute
   * method calls.
   *
