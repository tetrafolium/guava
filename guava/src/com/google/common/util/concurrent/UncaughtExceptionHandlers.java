...
public final class UncaughtExceptionHandlers {
   ...
   * </pre>
   *
   * <p>The returned handler logs any exception at severity {@code SEVERE} and
   * then shuts down the process with an exit status of 1, indicating abnormal
   * termination.
   */
  ...
  static final class Exiter implements UncaughtExceptionHandler {
    private static final Logger logger =
        Logger.getLogger(Exiter.class.getName());

    private final Runtime runtime;

    Exiter(Runtime runtime) { this.runtime = runtime; }
