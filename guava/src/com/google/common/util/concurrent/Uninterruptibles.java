...
public final class Uninterruptibles {
   ...
   * <li>To treat {@link InterruptedException} uniformly with other exceptions,
   * use
   ...
   * Futures.getChecked}. <li>To get uninterruptibility and remove checked
   * exceptions, use {@link Futures#getUnchecked}.
   * </ul>
   *
   * @throws ExecutionException if the computation threw an exception
   * @throws CancellationException if the computation was cancelled
