...
/**
 * An abstract {@code ExecutorService} that allows subclasses to {@linkplain
 * #wrapTask(Callable) wrap} tasks before they are submitted to the underlying
 * executor.
 *
...
abstract class WrappingExecutorService implements ExecutorService {
   ...
   */
  private final <T> ImmutableList<Callable<T>>
