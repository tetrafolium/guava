 ...
 * {@link Futures#transformAsync} have historically had bugs, and some of these
 * bugs are necessary, unavoidable consequences of the {@code CheckedFuture}
 * API. Additionally, {@code CheckedFuture} encourages users to take exceptions
 * from one thread and rethrow them in another, producing confusing stack
 * traces.
 *
 ...
 * InterruptedException} into the type specified by the {@code X} type
 * parameter.
 *
 * <p>This interface also extends the ListenableFuture interface to allow
 * listeners to be added. This allows the future to be used as a normal {@link
 * Future} or as an asynchronous callback mechanism as needed. This allows
 * multiple callbacks to be registered for a particular task, and the future
...
public interface CheckedFuture<V, X extends Exception>
   ...
   * {@link InterruptedException}, {@link CancellationException} and {@link
