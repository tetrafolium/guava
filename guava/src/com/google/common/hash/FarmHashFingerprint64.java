 ...
 *
 * <p>Its speed is comparable to CityHash64, and its quality of hashing is at
 * least as good.
 *
 * <p>Note to maintainers: This implementation relies on signed arithmetic being
...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
   ...
   * Results are returned in the output array because when we last measured,
  ...
  private static long hashLength65Plus(byte[] bytes, int offset, int length) {
    final int seed = 81;
    // For strings over 64 bytes we loop. Internal state consists of 56 bytes:
    // v, w, x, y, and z.
    long x = seed;
