 ...
 * all when it is
 * {@linkplain #close closed}. This is intended to approximately emulate the
 * behavior of Java 7's <a
 ...
 *   }}</pre>
 *
 * <p>Note that this try-catch-finally block is not equivalent to a
 ...
 * closed later. <li>If a {@code Throwable} is thrown in the try block, no
 * exceptions that occur when attempting to close resources will be thrown from
 * the finally block. The throwable from the try block will be thrown. <li>If no
 * exceptions or errors were thrown in the try block, the <i>first</i> exception
 * thrown by an attempt to close a resource will be thrown. <li>Any exception
 * caught when attempting to close a resource that is <i>not</i> thrown (because
 *     another exception is already being thrown) is <i>suppressed</i>.
 * </ul>
 *
 * <p>An exception that is suppressed is not thrown. The method of suppression
 * used depends on the version of Java the code is running on:
 *
 * <ul>
...
public final class Closer implements Closeable {
  ...
  private static final Suppressor SUPPRESSOR =
      SuppressingSuppressor.isAvailable() ? SuppressingSuppressor.INSTANCE
  ...
  Closer(Suppressor suppressor) {
    this.suppressor =
        checkNotNull(suppressor); // checkNotNull to satisfy null tests
  }
   ...
   * is an
   * {@code IOException}, {@code RuntimeException} or {@code Error}. Otherwise,
   * it will be rethrown wrapped in a {@code RuntimeException}. <b>Note:</b> Be
   * sure to declare all of the checked exception types your try block can throw
   * when calling an overload of this method so as to avoid losing the original
   * exception type.
   *
   * <p>This method always throws, and as such should be called as {@code throw
   * closer.rethrow(e);} to ensure the compiler knows that it will throw.
   *
   ...
   * Stores the given throwable and rethrows it. It will be rethrown as is if it
   * is an
   * {@code IOException}, {@code RuntimeException}, {@code Error} or a checked
   * exception of the given type. Otherwise, it will be rethrown wrapped in a
   * {@code RuntimeException}. <b>Note:</b> Be sure to declare all of the
   * checked exception types your try block can throw when calling an overload
   ...
   * is an
   * {@code IOException}, {@code RuntimeException}, {@code Error} or a checked
   * exception of either of the given types. Otherwise, it will be rethrown
   * wrapped in a {@code RuntimeException}. <b>Note:</b> Be sure to declare all
   * of the checked exception types your try block can throw when calling an
  ...
  /**
   * Closes all {@code Closeable} instances that have been added to this {@code
   * Closer}. If an exception was thrown in the try block and passed to one of
   * the {@code exceptionThrown} methods, any exceptions thrown when attempting
   ...
   * and any additional exceptions that are thrown after that will be
   * suppressed.
   */
  @Override
  ...
  interface Suppressor {
     ...
     * attempting to close the given closeable. {@code thrown} is the exception
     * that is actually being thrown from the method. Implementations of this
     * method should not throw under any circumstances.
     */
  ...
  static final class SuppressingSuppressor implements Suppressor {
    ...
    static boolean isAvailable() { return addSuppressed != null; }
