...
public class XmlEscapers {
   ...
   * See section <a
   * href="http://www.w3.org/TR/2008/REC-xml-20081126/#syntax">2.4</a> of the
   * XML specification.
   *
   * <p><b>Note:</b> Double and single quotes are not escaped, so it is <b>not
   * safe</b> to use this escaper to escape attribute values. Use {@link
   * #xmlContentEscaper} if the output can appear in element content or {@link
   ...
   */
  public static Escaper xmlContentEscaper() { return XML_CONTENT_ESCAPER; }

  /**
   * Returns an {@link Escaper} instance that escapes special characters in a
   * string so it can safely be included in XML document as an attribute value.
   * See section <a
   * href="http://www.w3.org/TR/2008/REC-xml-20081126/#AVNormalize">3.3.3</a> of
   ...
   * "&#xA;"}, and
   * {@code "&#xD;"} respectively. Any other non-ASCII characters appearing in
   * the input will be preserved in the output.
   *
   * <p>This escaper does not treat surrogate pairs specially and does not
   * perform Unicode validation on its input.
   */
  public static Escaper xmlAttributeEscaper() { return XML_ATTRIBUTE_ESCAPER; }
