...
public abstract class ImmutableTable<R, C, V>
   ...
   * ImmutableTable}. Each input element is mapped to one cell in the returned
   * table, with the rows, columns, and values generated by applying the
   * specified functions.
   *
   * <p>The returned {@code Collector} will throw a {@code NullPointerException}
   * at collection time if the row, column, or value functions return null on
   * any input.
   *
   * @since 21.0
   */
  @Beta
  public static <T, R, C, V> Collector<T, ?, ImmutableTable<R, C, V>>
  toImmutableTable(Function<? super T, ? extends R> rowFunction,
    ...
    return Collector.of(()
               ...
               (builder, t)
               ->builder.put(rowFunction.apply(t),
               columnFunction.apply(t),
               valueFunction.apply(t)),
   ...
   * ImmutableTable}. Each input element is mapped to one cell in the returned
   * table, with the rows, columns, and values generated by applying the
   * specified functions. If multiple inputs are mapped to the same row and
   * column pair, they will be combined with the specified merging function in
   * encounter order.
   *
   * <p>The returned {@code Collector} will throw a {@code NullPointerException}
   * at collection time if the row, column, value, or merging functions return
   * null on any input.
   *
   * @since 21.0
   */
  ...
  toImmutableTable(Function<? super T, ? extends R> rowFunction,
     ...
     * ImmutableTable.Builder, but the Builder can't efficiently support merging
     * of duplicate values.  Getting around this requires some work.
     */
    ...
    return Collector.of(
      ...
      (state, input)
      ->state.put(rowFunction.apply(input), columnFunction.apply(input),
  ...
  private static final class CollectorState<R, C, V> {
    ...
    CollectorState<R, C, V> combine(CollectorState<R, C, V> other,
    ...
    ImmutableTable<R, C, V> toTable() { return copyOf(insertionOrder); }
  }
