...
public class ImmutableListMultimap<K, V>
   ...
   * ImmutableListMultimap} whose keys and values are the result of applying the
   ...
   *           .collect(toImmutableListMultimap(str -> str.charAt(0), str ->
   * str.substring(1)));
   *
   *   // is equivalent to
   *
   ...
   * ImmutableListMultimap}. Each input element is mapped to a key and a stream
   ...
   *
   * <pre>{@code
   * static final ImmutableListMultimap<Character, Character>
   * FIRST_LETTER_MULTIMAP = Stream.of("banana", "apple", "carrot", "asparagus",
   * "cherry") .collect( flatteningToImmutableListMultimap( str ->
   * str.charAt(0), str -> str.substring(1).chars().mapToObj(c -> (char) c));
   *
   * // is equivalent to
   *
   * static final ImmutableListMultimap<Character, Character>
   * FIRST_LETTER_MULTIMAP = ImmutableListMultimap.<Character,
