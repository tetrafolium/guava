 ...
 * behavior of the backing multiset as desired per the <a
 ...
 * overriding
 * {@link #add(Object, int)} alone <b>will not</b> change the behavior of {@link
 * #add(Object)}, which can lead to unexpected behavior. In this case, you
 * should override {@code add(Object)} as well, either providing your own
...
public abstract class ForwardingSortedMultiset<E>
  ...
  @Override protected abstract SortedMultiset<E> delegate();
   ...
   * the following methods: {@link SortedMultiset#clear}, {@link
   * SortedMultiset#comparator}, {@link SortedMultiset#contains}, {@link
   * SortedMultiset#containsAll}, {@link SortedMultiset#count},
   * {@link SortedMultiset#firstEntry} {@link SortedMultiset#headMultiset},
   * {@link SortedMultiset#isEmpty}, {@link SortedMultiset#lastEntry}, {@link
   * SortedMultiset#subMultiset},
   * {@link SortedMultiset#tailMultiset}, the {@code size()} and {@code
   * iterator()} methods of
   * {@link SortedMultiset#entrySet}, and {@link SortedMultiset#remove(Object,
   * int)}. In many situations, you may wish to override {@link
   * SortedMultiset#elementSet} to forward to this implementation or a subclass
   * thereof.
   */
  protected class StandardElementSet
    extends SortedMultisets.NavigableElementSet<E> {
    /** Constructor for use by subclasses. */
    public StandardElementSet() { super(ForwardingSortedMultiset.this); }
  }
   ...
   * behavior of methods such as {@link #add(Object)} or {@link
   * #pollFirstEntry}. This skeleton implementation correctly delegates each of
   * its operations to the appropriate methods of this {@code
  ...
  /**
   * A sensible definition of {@link #firstEntry()} in terms of {@code
   * entrySet().iterator()}.
   *
  ...
  /**
   * A sensible definition of {@link #pollFirstEntry()} in terms of {@code
   * entrySet().iterator()}.
   *
   * If you override {@link #entrySet()}, you may wish to override {@link
   ...
   * descendingMultiset().entrySet().iterator()}.
   *
   * If you override {@link #descendingMultiset()} or {@link #entrySet()}, you
  ...
  /**
   * A sensible definition of {@link #subMultiset(Object, BoundType, Object,
   * BoundType)} in terms of {@link #headMultiset(Object, BoundType)
   * headMultiset} and
   * {@link #tailMultiset(Object, BoundType) tailMultiset}.
   *
   * If you override either of these methods, you may wish to override
   * {@link #subMultiset(Object, BoundType, Object, BoundType)} to forward to
   * this implementation.
   */
