...
final class GraphConstants {
  ...
  /**
   * Singleton edge value for {@link Graph} implementations backed by {@link
   * ValueGraph}s.
   */
  enum Presence { EDGE_EXISTS }
}
