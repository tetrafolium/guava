 ...
 * accepts a single argument of the type of event desired; <li>Mark it with a
 * {@link Subscribe} annotation; <li>Pass itself to an EventBus instance's
 ...
 * to any subscriber for any type to which the event is <em>assignable.</em>
 * This includes implemented interfaces, all superclasses, and all interfaces
 * implemented by superclasses.
 *
 * <p>When {@code post} is called, all registered subscribers for an event are
 * run in sequence, so subscribers should be reasonably quick. If an event may
 ...
 * subscriber methods need not worry about being reentrant, unless also called
 * from outside the EventBus.
 *
 * <h2>Dead Events</h2>
 *
 ...
 * registered, no event will ever be considered dead, and no DeadEvents will be
 * generated. Accordingly, while DeadEvent extends {@link Object}, a subscriber
