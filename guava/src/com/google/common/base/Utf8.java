...
/**
 * Low-level, high-performance utility methods related to the {@linkplain
 * Charsets#UTF_8 UTF-8} character encoding. UTF-8 is defined in section D92 of
 * <a href="http://www.unicode.org/versions/Unicode6.2.0/ch03.pdf">The Unicode
 * Standard Core Specification, Chapter 3</a>.
 *
 * <p>The variant of UTF-8 implemented by this class is the restricted
 * definition of UTF-8 introduced in Unicode 3.1. One implication of this is
 * that it rejects <a
 * href="http://www.unicode.org/versions/corrigendum1.html">"non-shortest
...
public final class Utf8 {
   ...
   * For a string, this method is equivalent to {@code
   * string.getBytes(UTF_8).length}, but is more efficient in both time and
   * space.
   *
   ...
   * the JDK decoder will accept "non-shortest form" byte sequences, but
   * encoding never reproduces these. Such byte sequences are <i>not</i>
   * considered well-formed.
   *
   * <p>This method returns {@code true} if and only if {@code
   * Arrays.equals(bytes, new String(bytes, UTF_8).getBytes(UTF_8))} does, but
