...
public final class Functions {
  ...
  private enum IdentityFunction implements Function<Object, Object> {
    ...
    @Override
    @Nullable
    public Object apply(final @Nullable Object o) {
      return o;
    }
  ...
  private static class FunctionForMapNoDefault<K, V> implements Function<K, V>, Serializable {
    ...
    @Override
    public V apply(final @Nullable K key) {
   ...
   */
  public static <K, V> Function<K, V> forMap(final Map<K, ? extends V> map, final @Nullable V defaultValue) {
  ...
  private static class ForMapWithDefault<K, V> implements Function<K, V>, Serializable {
    ...
    ForMapWithDefault(final Map<K, ? extends V> map, final @Nullable V defaultValue) {
      this.map = checkNotNull(map);
  ...
  private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
    ...
    @Override
    public C apply(final @Nullable A a) {
  ...
  private static class ConstantFunction<E> implements Function<Object, E>, Serializable {
    ...
    public ConstantFunction(final @Nullable E value) {
      this.value = value;
    }

    @Override
    public E apply(final @Nullable Object from) {
      return value;
    }
  ...
  private static class SupplierFunction<T> implements Function<Object, T>, Serializable {
    ...
    @Override
    public T apply(final @Nullable Object input) {
      return supplier.get();
    }
