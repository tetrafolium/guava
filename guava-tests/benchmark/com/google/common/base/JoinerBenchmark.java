...
public class JoinerBenchmark {
  ...
  private static final Joiner JOINER_ON_CHARACTER =
      Joiner.on(DELIMITER_CHARACTER);
   ...
   * like ignoring {@code null} values are used.
   */
  @Benchmark
   ...
   * Note: this isn't a candidate implementation for Joiner since it fails on
   * leading empty components.
   */
  @Benchmark
  ...
  /**
   * Starts with an empty delimiter and changes to the desired value at the end
   * of the iteration.
   */
  @Benchmark
  ...
  /**
   * Always append the delimiter after the component, and in the very end
   * shortens the buffer to get rid of the extra trailing delimiter.
   */
  @Benchmark
