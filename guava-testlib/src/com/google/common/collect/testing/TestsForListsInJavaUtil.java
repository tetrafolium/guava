...
public class TestsForListsInJavaUtil {
  ...
  protected Collection<Method> suppressForCopyOnWriteArrayList() {
    return asList(getSubListOriginalListSetAffectsSubListMethod(),
    ...
    return ListTestSuiteBuilder
      ...
      public List<String> create(String[] elements) {
        return Arrays.asList(elements.clone());
           ...
           .named("Arrays.asList")
           .withFeatures(ListFeature.SUPPORTS_SET, CollectionFeature.SERIALIZABLE,
    ...
    return ListTestSuiteBuilder
      ...
      public List<String> create(String[] elements) {
        return new CopyOnWriteArrayList<>(MinimalCollection.of(elements));
           ...
           .withFeatures(ListFeature.SUPPORTS_ADD_WITH_INDEX,
               ListFeature.SUPPORTS_REMOVE_WITH_INDEX,
               ListFeature.SUPPORTS_SET, CollectionFeature.SUPPORTS_ADD,
